                    ...
                    <?php while ($r->have_posts()) : $r->the_post(); ?>
                        ...
                        <div class="project col-md-4 col-sm-6 col-xs-6 wow zoomIn">
                            <div class="project-image">
                                ...
                                <?php if ($project_url) : ?>
                                    <a class="link-icon" href="<?php echo esc_url($project_url); ?>" title="<?php the_title(); ?>" target="_blank"><i class="fa fa-link"></i></a>
                                <?php else : ?>
                                    <a class="link-icon" href="<?php the_permalink(); ?>" title="<?php the_title(); ?>" target="_blank"><i class="fa fa-link"></i></a>
                                <?php endif; ?>
                                <?php
                                global $post;
                            ...
                            <span class="employee-position" style="visibility: visible;"><?php the_title(); ?></span>
                        </div>
                    <?php endwhile; ?>
                </div>
                <?php if ($see_all != '') : ?>
