            ...
            <?php if (get_header_image() && $himage == '') : ?>
                ...
                <?php elseif ($himage != '') : ?>	
                    <header id="masthead" class="site-header has-banner" role="banner">
                        ...
                        <video autoplay style="  z-index: 1;
                               position: absolute;
                               height: 110%;
                               margin-top: -66px;" poster="http://www.webfocusstudio.com/wp-content/uploads/2015/04/Front_Page_static-e1428790831556.png" id="bgvid" loop>
                            <!-- WCAG general accessibility recommendation is that media such as background video play through only once. Loop turned on for the purposes of illustration; if removed, the end of the video will fade in the same way created by pressing the "Pause" button  -->

                            <source src="http://www.webfocusstudio.com/wp-content/uploads/2015/04/sunrise1.mp4" type="video/mp4">
                        </video>
